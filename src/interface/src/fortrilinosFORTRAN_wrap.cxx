...
SWIGEXPORT void _wrap_ForModelEvaluator_setup(SwigClassWrapper const *farg1, SwigClassWrapper const *farg2, SwigClassWrapper const *farg3) {
  ForModelEvaluator *arg1 = (ForModelEvaluator *) 0 ;
  Teuchos::RCP< ForModelEvaluator::map_type const > *arg2 = 0 ;
  Teuchos::RCP< ForModelEvaluator::map_type const > *arg3 = 0 ;
  Teuchos::RCP< ForModelEvaluator > *smartarg1 ;
  Teuchos::RCP< ForModelEvaluator::map_type const > tempnull2 ;
  Teuchos::RCP< ForModelEvaluator::map_type const > tempnull3 ;

  smartarg1 = static_cast< Teuchos::RCP< ForModelEvaluator >* >(farg1->ptr);
  arg1 = smartarg1 ? smartarg1->get() : NULL;
  arg2 = farg2->ptr ? static_cast< Teuchos::RCP< ForModelEvaluator::map_type const > * >(farg2->ptr) : &tempnull2;
  arg3 = farg3->ptr ? static_cast< Teuchos::RCP< ForModelEvaluator::map_type const > * >(farg3->ptr) : &tempnull3;
  {
    // Make sure no unhandled exceptions exist before performing a new action
    SWIG_check_unhandled_exception_impl("ForModelEvaluator::setup(Teuchos::RCP< ForModelEvaluator::map_type const > const &,Teuchos::RCP< ForModelEvaluator::map_type const > const &)");;
    try
    {
      // Attempt the wrapped function call
      (arg1)->setup((Teuchos::RCP< ForModelEvaluator::map_type const > const &)*arg2,(Teuchos::RCP< ForModelEvaluator::map_type const > const &)*arg3);
    }
    catch (const std::range_error& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("ForModelEvaluator::setup(Teuchos::RCP< ForModelEvaluator::map_type const > const &,Teuchos::RCP< ForModelEvaluator::map_type const > const &)", SWIG_IndexError, e.what(), return );
    }
    catch (const std::exception& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("ForModelEvaluator::setup(Teuchos::RCP< ForModelEvaluator::map_type const > const &,Teuchos::RCP< ForModelEvaluator::map_type const > const &)", SWIG_RuntimeError, e.what(), return );
    }
    catch (...)
    {
      SWIG_exception_impl("ForModelEvaluator::setup(Teuchos::RCP< ForModelEvaluator::map_type const > const &,Teuchos::RCP< ForModelEvaluator::map_type const > const &)", SWIG_UnknownError, "An unknown exception occurred", return );
    }
  }
...
SWIGEXPORT void _wrap_ForModelEvaluator_evaluate_residual(SwigClassWrapper const *farg1, SwigClassWrapper const *farg2) {
  ForModelEvaluator *arg1 = (ForModelEvaluator *) 0 ;
  Teuchos::RCP< ForModelEvaluator::multivector_type > *arg2 = 0 ;
  Teuchos::RCP< ForModelEvaluator const > *smartarg1 ;
  Teuchos::RCP< ForModelEvaluator::multivector_type > tempnull2 ;

  smartarg1 = static_cast< Teuchos::RCP<const ForModelEvaluator >* >(farg1->ptr);
  arg1 = smartarg1 ? const_cast<ForModelEvaluator*>(smartarg1->get()) : NULL;
  arg2 = farg2->ptr ? static_cast< Teuchos::RCP< ForModelEvaluator::multivector_type > * >(farg2->ptr) : &tempnull2;
  {
    // Make sure no unhandled exceptions exist before performing a new action
    SWIG_check_unhandled_exception_impl("ForModelEvaluator::evaluate_residual(Teuchos::RCP< ForModelEvaluator::multivector_type > &) const");;
    try
    {
      // Attempt the wrapped function call
      ((ForModelEvaluator const *)arg1)->evaluate_residual(*arg2);
    }
    catch (const std::range_error& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("ForModelEvaluator::evaluate_residual(Teuchos::RCP< ForModelEvaluator::multivector_type > &) const", SWIG_IndexError, e.what(), return );
    }
    catch (const std::exception& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("ForModelEvaluator::evaluate_residual(Teuchos::RCP< ForModelEvaluator::multivector_type > &) const", SWIG_RuntimeError, e.what(), return );
    }
    catch (...)
    {
      SWIG_exception_impl("ForModelEvaluator::evaluate_residual(Teuchos::RCP< ForModelEvaluator::multivector_type > &) const", SWIG_UnknownError, "An unknown exception occurred", return );
    }
  }
...
SWIGEXPORT void _wrap_ForModelEvaluator_evaluate_jacobian(SwigClassWrapper const *farg1, SwigClassWrapper const *farg2) {
  ForModelEvaluator *arg1 = (ForModelEvaluator *) 0 ;
  Teuchos::RCP< ForModelEvaluator::operator_type > *arg2 = 0 ;
  Teuchos::RCP< ForModelEvaluator const > *smartarg1 ;
  Teuchos::RCP< ForModelEvaluator::operator_type > tempnull2 ;

  smartarg1 = static_cast< Teuchos::RCP<const ForModelEvaluator >* >(farg1->ptr);
  arg1 = smartarg1 ? const_cast<ForModelEvaluator*>(smartarg1->get()) : NULL;
  arg2 = farg2->ptr ? static_cast< Teuchos::RCP< ForModelEvaluator::operator_type > * >(farg2->ptr) : &tempnull2;
  {
    // Make sure no unhandled exceptions exist before performing a new action
    SWIG_check_unhandled_exception_impl("ForModelEvaluator::evaluate_jacobian(Teuchos::RCP< ForModelEvaluator::operator_type > &) const");;
    try
    {
      // Attempt the wrapped function call
      ((ForModelEvaluator const *)arg1)->evaluate_jacobian(*arg2);
    }
    catch (const std::range_error& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("ForModelEvaluator::evaluate_jacobian(Teuchos::RCP< ForModelEvaluator::operator_type > &) const", SWIG_IndexError, e.what(), return );
    }
    catch (const std::exception& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("ForModelEvaluator::evaluate_jacobian(Teuchos::RCP< ForModelEvaluator::operator_type > &) const", SWIG_RuntimeError, e.what(), return );
    }
    catch (...)
    {
      SWIG_exception_impl("ForModelEvaluator::evaluate_jacobian(Teuchos::RCP< ForModelEvaluator::operator_type > &) const", SWIG_UnknownError, "An unknown exception occurred", return );
    }
  }
...
SWIGEXPORT void _wrap_ForModelEvaluator_evaluate_preconditioner(SwigClassWrapper const *farg1, SwigClassWrapper const *farg2) {
  ForModelEvaluator *arg1 = (ForModelEvaluator *) 0 ;
  Teuchos::RCP< ForModelEvaluator::operator_type > *arg2 = 0 ;
  Teuchos::RCP< ForModelEvaluator const > *smartarg1 ;
  Teuchos::RCP< ForModelEvaluator::operator_type > tempnull2 ;
  ...
  {
    // Make sure no unhandled exceptions exist before performing a new action
    SWIG_check_unhandled_exception_impl("ForModelEvaluator::evaluate_preconditioner(Teuchos::RCP< ForModelEvaluator::operator_type > &) const");;
    try
    {
      // Attempt the wrapped function call
      ((ForModelEvaluator const *)arg1)->evaluate_preconditioner(*arg2);
    }
    catch (const std::range_error& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("ForModelEvaluator::evaluate_preconditioner(Teuchos::RCP< ForModelEvaluator::operator_type > &) const", SWIG_IndexError, e.what(), return );
    }
    catch (const std::exception& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("ForModelEvaluator::evaluate_preconditioner(Teuchos::RCP< ForModelEvaluator::operator_type > &) const", SWIG_RuntimeError, e.what(), return );
    }
    catch (...)
    {
      SWIG_exception_impl("ForModelEvaluator::evaluate_preconditioner(Teuchos::RCP< ForModelEvaluator::operator_type > &) const", SWIG_UnknownError, "An unknown exception occurred", return );
    }
  }
...
SWIGEXPORT void _wrap_ForModelEvaluator_update_x(SwigClassWrapper const *farg1, SwigClassWrapper const *farg2) {
  ForModelEvaluator *arg1 = (ForModelEvaluator *) 0 ;
  ...
  {
    // Make sure no unhandled exceptions exist before performing a new action
    SWIG_check_unhandled_exception_impl("ForModelEvaluator::update_x(Teuchos::RCP< ForModelEvaluator::multivector_type const > const &) const");;
    try
    {
      // Attempt the wrapped function call
      ((ForModelEvaluator const *)arg1)->update_x((Teuchos::RCP< ForModelEvaluator::multivector_type const > const &)*arg2);
    }
    catch (const std::range_error& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("ForModelEvaluator::update_x(Teuchos::RCP< ForModelEvaluator::multivector_type const > const &) const", SWIG_IndexError, e.what(), return );
    }
    catch (const std::exception& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("ForModelEvaluator::update_x(Teuchos::RCP< ForModelEvaluator::multivector_type const > const &) const", SWIG_RuntimeError, e.what(), return );
    }
    catch (...)
    {
      SWIG_exception_impl("ForModelEvaluator::update_x(Teuchos::RCP< ForModelEvaluator::multivector_type const > const &) const", SWIG_UnknownError, "An unknown exception occurred", return );
    }
  }
